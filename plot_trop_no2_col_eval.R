...
nc0 <- open.ncdf(paste(obs.dir, "OMI/NO2/OMI_NO2_2005_N48.nc", sep=""))
...
omi.no2 <- get.var.ncdf(nc0, "OMI_NO2") # OMI trop NO2 in molecules cm-2 (E15)
...
# ###################################################################################################################################
pdf(file=paste(out.dir,mod1.name,"_Trop_NO2_col.pdf", sep=""),width=8,height=6,paper="special",onefile=TRUE,pointsize=12)
