...
intex.na.ec.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
intex.na.ec.mod.m1 <- apply(intex.na.ec.mod.1,c(3),quantile)

data <- "intex.na.ct"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
intex.na.ct.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
intex.na.ct.mod.m1 <- apply(intex.na.ct.mod.1,c(3),quantile)

data <- "intex.na.ne"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
intex.na.ne.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
intex.na.ne.mod.m1 <- apply(intex.na.ne.mod.1,c(3),quantile)

data <- "intex.na.wc"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
intex.na.wc.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
intex.na.wc.mod.m1 <- apply(intex.na.wc.mod.1,c(3),quantile)

data <- "op3"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
op3.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
op3.mod.m1 <- apply(op3.mod.1,c(3),quantile)

data <- "pem.t.b.ci"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
pem.t.b.ci.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
pem.t.b.ci.mod.m1 <- apply(pem.t.b.ci.mod.1,c(3),quantile)

data <- "pem.t.b.t"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
pem.t.b.t.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
pem.t.b.t.mod.m1 <- apply(pem.t.b.t.mod.1,c(3),quantile)

data <- "pem.w.b.j"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
pem.w.b.j.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
pem.w.b.j.mod.m1 <- apply(pem.w.b.j.mod.1,c(3),quantile)

data <- "trace.a.e.b"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
trace.a.e.b.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
trace.a.e.b.mod.m1 <- apply(trace.a.e.b.mod.1,c(3),quantile)

data <- "trace.a.e.b"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
trace.a.e.b.c.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
trace.a.e.b.c.mod.m1 <- apply(trace.a.e.b.c.mod.1,c(3),quantile)

data <- "trace.a.s.af"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
trace.a.s.af.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
trace.a.s.af.mod.m1 <- apply(trace.a.s.af.mod.1,c(3),quantile)

data <- "trace.a.w.a.c"
source(paste(script.dir, "extract_emmons_coords.R", sep=""))
trace.a.w.a.c.mod.1 <- get.var.ncdf(nc1,pan.code,start=c(lon1,lat1,1,mon),count=c(d.lon1,d.lat1,60,d.mon))*(conv/mm.pan)
trace.a.w.a.c.mod.m1 <- apply(trace.a.w.a.c.mod.1,c(3),quantile)

# ################## read obs ##################################################### #
intex.na.ec.data <- read.table(paste(obs.dir, "INTEX-NA/INTEX-NA_EC_pan.stat", sep=""))
intex.na.ec.dat.sd1 = intex.na.ec.data$V5 + intex.na.ec.data$V6
intex.na.ec.dat.sd2 = intex.na.ec.data$V5 - intex.na.ec.data$V6

intex.na.ct.data <- read.table(paste(obs.dir, "INTEX-NA/INTEX-NA_CT_pan.stat", sep=""))
intex.na.ct.dat.sd1 = intex.na.ct.data$V5 + intex.na.ct.data$V6
intex.na.ct.dat.sd2 = intex.na.ct.data$V5 - intex.na.ct.data$V6

intex.na.ne.data <- read.table(paste(obs.dir, "INTEX-NA/INTEX-NA_NE_pan.stat", sep=""))
intex.na.ne.dat.sd1 = intex.na.ne.data$V5 + intex.na.ne.data$V6
intex.na.ne.dat.sd2 = intex.na.ne.data$V5 - intex.na.ne.data$V6

intex.na.wc.data <- read.table(paste(obs.dir, "INTEX-NA/INTEX-NA_WC_pan.stat", sep=""))
intex.na.wc.dat.sd1 = intex.na.wc.data$V5 + intex.na.wc.data$V6
intex.na.wc.dat.sd2 = intex.na.wc.data$V5 - intex.na.wc.data$V6

#op3.data <- read.csv(paste(obs.dir, "OP3/OP3_pan.stat", sep=""), header = F, skip=1)
#op3.dat.sd1 = op3.data$V5 + op3.data$V6
#op3.dat.sd2 = op3.data$V5 - op3.data$V6

pem.t.b.ci.data <- read.table(paste(obs.dir, "emmons_data/regional/PEM-Tropics-B/PEM-Tropics-B_DC8_pan_Christmas-Island.stat", sep=""))
pem.t.b.ci.dat.sd1 = pem.t.b.ci.data$V5 + pem.t.b.ci.data$V6
pem.t.b.ci.dat.sd2 = pem.t.b.ci.data$V5 - pem.t.b.ci.data$V6

pem.t.b.t.data <- read.table(paste(obs.dir, "emmons_data/regional/PEM-Tropics-B/PEM-Tropics-B_DC8_pan_Tahiti.stat", sep=""))
pem.t.b.t.dat.sd1 = pem.t.b.t.data$V5 + pem.t.b.t.data$V6
pem.t.b.t.dat.sd2 = pem.t.b.t.data$V5 - pem.t.b.t.data$V6

pem.w.b.j.data <- read.table(paste(obs.dir, "emmons_data/regional/PEM-West-B/PEM-West-B_DC-8_pan_Japan.stat", sep=""))
pem.w.b.j.dat.sd1 = pem.w.b.j.data$V5 + pem.w.b.j.data$V6
pem.w.b.j.dat.sd2 = pem.w.b.j.data$V5 - pem.w.b.j.data$V6

trace.a.e.b.data <- trace.a.e.b.data <- read.table(paste(obs.dir, "emmons_data/regional/TRACE-A/TRACE-A_DC-8_pan_E-Brazil.stat", sep=""))
trace.a.e.b.dat.sd1 = trace.a.e.b.data$V5 + trace.a.e.b.data$V6
trace.a.e.b.dat.sd2 = trace.a.e.b.data$V5 - trace.a.e.b.data$V6

trace.a.e.b.c.data <- read.table(paste(obs.dir, "emmons_data/regional/TRACE-A/TRACE-A_DC-8_pan_E-Brazil-Coast.stat", sep=""))
...
trace.a.s.af.data <- read.table(paste(obs.dir, "emmons_data/regional/TRACE-A/TRACE-A_DC-8_pan_S-Africa.stat", sep=""))
...
trace.a.w.a.c.data <- read.table(paste(obs.dir, "emmons_data/regional/TRACE-A/TRACE-A_DC-8_pan_W-Africa-Coast.stat", sep=""))
...
# ################ Plot data ###################################################### #
# output
pdf(file=paste(out.dir,mod1.name,"_Emmons_PAN_Multi.pdf",sep=""),width=16,height=24,pointsize=24)
#
par(mfrow=c(4,3))
par(oma=c(0,0,1,0)) 
par(mgp = c(2, 1, 0))

plot(intex.na.ec.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
title(main="\nEmmons PAN comparison",outer=T, col.main="red")

plot(intex.na.ct.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(intex.na.ne.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(intex.na.wc.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(op3.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(pem.t.b.ci.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(pem.t.b.t.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(pem.w.b.j.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(trace.a.e.b.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(trace.a.e.b.c.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(trace.a.s.af.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
...
plot(trace.a.w.a.c.mod.m1[3,1:hgt.10], hgt[1:hgt.10], type = "o", pch=13, col="white", lwd=1,xlab="PAN (pptv)",
ylab="Altitude /km", 
