...
data.months<-abind(JanO3,FebO3,MarO3,AprO3,MayO3,JunO3,JulO3,AugO3,SepO3,OctO3,NovO3,DecO3)/2.0
...
# ###############################################################################################
pdf(file=paste(out.dir,  mod1.name, "_", mod2.name, "_", mod3.name,  "_EMEP_O3_comparison.pdf", sep=""),width=8,height=6,paper="special",
...
title(main="All EMEP stations 2005",cex.main=0.9)
legend("topleft",c("EMEP obs (2005)",mod1.type,mod2.type,mod3.type),col=c("black","red","blue","green"),lty=c(1,1,1,1),lwd=4,bty="n")
legend("bottomright",c("# sites = 133"),box.lty=0,cex=0.9)
