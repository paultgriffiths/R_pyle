# R list of mol masses of UKCA species!

# Alex Archibald, CAS, January 2012
#c.species = m.species/m.air
#m.air = 28.97 g/mol
...
mm.mecf2cl   <- 3.4673
mm.cf2br2    <- 7.2489
mm.cf2brcf2br<- 8.9748
mm.cf2clcf3  <- 5.3314
mm.cf2clcf2cl<- 5.8992
mm.mecfcl2   <- 4.0352
mm.c5h8      <- 2.3473 
mm.iso2      <- 4.0387       
mm.isooh     <- 4.0732 
mm.ison      <- 5.3504  # might be revised to 5.0052
